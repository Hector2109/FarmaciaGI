...
public class ProductoAux {
    ...
    public ProductoAux(String codigo) {
        this.codigo = codigo;
        this.nombre = null;
        this.marca = null;
        this.costo = null;
    ...
    public ProductoAux(String codigo, String nombre) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.marca = null;
        this.costo = null;
     ...
     * @param cantidad
     */
    public ProductoAux(String nombre, Float costo, String marca, String codigo, Integer cantidad) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.costo = costo;
        this.marca = marca;
    ...
    public boolean equals(Object obj) {
        ...
        final ProductoAux other = (ProductoAux) obj;
